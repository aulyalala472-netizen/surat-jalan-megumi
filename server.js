...
// ==========================================
// OPTIMISASI MONGODB KHUSUS VERCEL (SERVERLESS)
// ==========================================
mongoose.set('bufferCommands', false); // Mencegah Mongoose menggantung jika belum terkoneksi
...
const connectDB = async () => {
  ...
  if (!MONGODB_URI) {
    console.warn('⚠️ MONGODB_URI belum dikonfigurasi pada environment variables!');
    return;
  }
...
// 2. Setup Multer Storage untuk Cloudinary
const storage = new CloudinaryStorage({
  cloudinary: cloudinary,
  params: {
    folder: 'surat_jalan_photos', // Nama folder di dashboard Cloudinary
...
const SuratJalan = mongoose.models.SuratJalan || mongoose.model('SuratJalan', suratJalanSchema);
